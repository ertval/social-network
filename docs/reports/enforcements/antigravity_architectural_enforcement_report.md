...
3.  **Module Federation Encapsulation:** Architects configure webpack federation plugins to expose *only* the entry shell and bundle runtime packages as singletons.
    ```javascript
