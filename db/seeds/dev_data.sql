...
('df16d238-e4dd-4645-9101-54aed9c0fbf4', 1, 'Welcome to the Forum', 'This is a sample topic created for testing purposes.', NULL),
('000dec3a-51af-4e7c-ae0c-21436a0a2395', 2, 'Feedback on New Features', 'What do you think about the new features?', NULL),
('f1433622-9c10-44e5-94b1-1f6a148c9131', 3, 'Forum Guidelines', 'Please read the forum guidelines before posting.', NULL);
