...
-- Sessions
INSERT INTO sessions (token, user_id, expires_at, refresh_token, refresh_token_expires_at) VALUES
('dev_session_token_1', 'df16d238-e4dd-4645-9101-54aed9c0fbf4', CURRENT_TIMESTAMP + INTERVAL '7 days', 'dev_refresh_token_1', CURRENT_TIMESTAMP + INTERVAL '30 days'),
('dev_session_token_2', '000dec3a-51af-4e7c-ae0c-21436a0a2395', CURRENT_TIMESTAMP + INTERVAL '7 days', 'dev_refresh_token_2', CURRENT_TIMESTAMP + INTERVAL '30 days'),
('dev_session_token_3', 'f1433622-9c10-44e5-94b1-1f6a148c9131', CURRENT_TIMESTAMP + INTERVAL '7 days', 'dev_refresh_token_3', CURRENT_TIMESTAMP + INTERVAL '30 days')
ON CONFLICT (token) DO NOTHING;

-- Categories
INSERT INTO categories (name, description, created_by, color, slug, image_path) VALUES
...
-- Topics
INSERT INTO topics (user_id, title, content, image_path) VALUES
...
-- Votes
INSERT INTO votes (user_id, topic_id, comment_id, reaction_type) VALUES
...
-- Chat Threads
INSERT INTO direct_chats (id, user_low_id, user_high_id, last_message_id, last_message_at) VALUES
...
-- Chat Messages
INSERT INTO chat_messages (chat_id, sender_id, content, client_message_id) VALUES
...
-- Chat reads
INSERT INTO chat_reads (chat_id, user_id, last_read_message_id) VALUES
