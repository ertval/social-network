...
var (
	...
	commitPattern = regexp.MustCompile(`^(feat|fix|test|refactor|chore|docs|style|perf|ci|build|revert)(?:\((user|topic|follow|group|event|chat|notification|oauth|core|platform|comment|docs)\))?!?:`)
)
