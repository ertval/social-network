...
Guidelines for project technologies, refactoring patterns, and Go development best practices. For detailed instructions, see [general-instructions.md](file://docs/plan/sprints/general-instructions.md).
